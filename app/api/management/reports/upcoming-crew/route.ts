...
export async function GET(request: NextRequest) {
  try {
    ...
    let externalUrl = `${EXTERNAL_API_BASE}/api/management/reports/upcoming-crew`;
    ...
    console.log('✅ Successfully fetched upcoming crew report from external API');
    ...
    console.error('❌ Error proxying upcoming crew report request:', error.message);
    return NextResponse.json(
      { 
        success: false, 
        error: 'Failed to fetch upcoming crew report from external API',
