...
export async function GET(request: NextRequest) {
  try {
    ...
    let externalUrl = `${EXTERNAL_API_BASE}/api/management/reports/payroll`;
    ...
    console.log('✅ Successfully fetched payroll report from external API');
    ...
    console.error('❌ Error proxying payroll report request:', error.message);
    return NextResponse.json(
      { 
        success: false, 
        error: 'Failed to fetch payroll report from external API',
