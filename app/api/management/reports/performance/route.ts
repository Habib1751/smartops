...
export async function GET(request: NextRequest) {
  try {
    ...
    let externalUrl = `${EXTERNAL_API_BASE}/api/management/reports/performance`;
    ...
    console.log('✅ Successfully fetched performance report from external API');
    ...
    console.error('❌ Error proxying performance report request:', error.message);
    return NextResponse.json(
      { 
        success: false, 
        error: 'Failed to fetch performance report from external API',
